#!/usr/bin/env python3
"""
Sender App with Real Validation - Main application file
"""
import os
import sqlite3
...
from real_validation import validation_api
...
DATABASE = os.path.join(os.path.dirname(__file__), 'sender.db')
