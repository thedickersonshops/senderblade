// Lists functionality - Simplified for sender app

// Global variables
let lists = [];
let currentPage = 1;
let contactsPerPage = 100;
...
async function viewList(listId) {
    try {
        ...
        const result = await api.getContacts(listId, currentPage, contactsPerPage);
                    ...
                    <div class="card-footer">
                        <nav aria-label="Contacts pagination">
                            <ul class="pagination justify-content-center mb-0">
                                ...
                                ${generatePaginationLinks(pagination.page, pagination.pages)}
                                
                                <li class="page-item ${pagination.page === pagination.pages ? 'disabled' : ''}">
                                    <a class="page-link" href="#" data-page="${pagination.page + 1}">Next</a>
                                </li>
                                <li class="page-item ${pagination.page === pagination.pages ? 'disabled' : ''}">
                                    <a class="page-link" href="#" data-page="${pagination.pages}">Last</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
